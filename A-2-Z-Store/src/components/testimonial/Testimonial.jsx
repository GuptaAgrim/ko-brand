...
import Agrim from "../../assets/photo/avtar1.jpeg"
import gaurav from "../../assets/photo/boss.jpeg"
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src={Agrim} />
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">"This shopping website offers a seamless and user-friendly experience with its intuitive interface, diverse product range, and efficient checkout process. The visually appealing design and responsive layout enhance the overall shopping journey, making it an excellent choice for online shoppers seeking convenience and variety.".</p>
